...
public class SetupActivity_Old extends WearableActivity {
    ...
    public void startServiceOnClickedCentral(View view) {
        mbluetoothCentral.stop(); //it will stop only if it is already running
        ...
        mService = new Intent(SetupActivity_Old.this, FGService.class);
